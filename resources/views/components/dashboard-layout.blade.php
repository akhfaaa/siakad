    ...
    <div class="min-h-screen flex w-full">
        ...
        <aside class="w-64 bg-white/80 backdrop-blur-xl border-r border-[#d2d2d7] fixed h-full z-20 flex flex-col transition-transform duration-300">
            ...
            <div class="flex-1 overflow-y-auto py-4 px-3 space-y-1.5">
                ...
                <a href="{{ route('tu.rombel') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg {{ request()->routeIs('tu.rombel*') ? 'bg-[#f5f5f7] text-[#1d1d1f] font-semibold' : 'text-[#515154] hover:bg-[#f5f5f7]/50 hover:text-[#1d1d1f] transition-colors' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"></path>
                    </svg>
                    Data Rombel
                </a>
                <a href="{{ route('tu.mapel') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg {{ request()->routeIs('tu.mapel*') ? 'bg-[#f5f5f7] text-[#1d1d1f] font-semibold' : 'text-[#515154] hover:bg-[#f5f5f7]/50 hover:text-[#1d1d1f] transition-colors' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
