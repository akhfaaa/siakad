    ...
    <aside class="w-64 bg-slate-900/40 backdrop-blur-2xl border-r border-white/[0.08] flex-col justify-between hidden md:flex z-20 relative shadow-2xl shadow-black/50">
        <div>
            ...
            <nav class="p-4 space-y-2">
                <a href="{{ route('dashboard') }}" class="flex items-center gap-3 px-4 py-3 rounded-xl {{ request()->routeIs('dashboard') ? 'bg-blue-600/20 text-blue-400 border border-blue-500/20 shadow-inner font-semibold' : 'text-slate-400 hover:text-white hover:bg-white/[0.05] transition-colors font-medium' }}">
                ...
                <a href="{{ route('siswa.absensi') }}" class="flex items-center gap-3 px-4 py-3 rounded-xl {{ request()->routeIs('siswa.absensi') ? 'bg-blue-600/20 text-blue-400 border border-blue-500/20 shadow-inner font-semibold' : 'text-slate-400 hover:text-white hover:bg-white/[0.05] transition-colors font-medium' }}">
                ...
                <a href="{{ route('siswa.jurnal') }}" class="flex items-center gap-3 px-4 py-3 rounded-xl {{ request()->routeIs('siswa.jurnal') ? 'bg-blue-600/20 text-blue-400 border border-blue-500/20 shadow-inner font-semibold' : 'text-slate-400 hover:text-white hover:bg-white/[0.05] transition-colors font-medium' }}">
                    <svg class="w-5 h-5 opacity-80" fill="none" stroke="currentColor" viewBox="0 0 24 24">
